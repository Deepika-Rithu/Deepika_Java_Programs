...
{
	@Test
	public void AddressSelection_PaymentSelection_Product_Review() throws InterruptedException
	{
			...
			Thread.sleep(3000);
			cp.usethispayment_button_click();
			Assert.assertEquals(cp.placeorder_button_display(), true, "Items cannot be reviewed");
	}
}
