...
{
	@Test
	public void SearchProduct_WithFilters() throws InterruptedException
	{
			...
			s1.Category_Selection();
			Assert.assertEquals(s1.Option_under_selected_category_display(),true,"Category not selected"); 
	}
}
